    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <p class="sub-header">
                    Create new user Day {{ Date('Y-m-d') }}
                </p>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Email:</strong> 
                            {!! Form::text('email', null, $attributes = $errors->has('email') ? array('placeholder' => 'Email', 'class'=>'form-control parsley-error') : array('placeholder' => 'Email', 'class'=>'form-control') ) !!}
                            @error('email')
                            <ul class="parsley-errors-list filled">
                                <li class="parsley-required">{{ $message }}</li>
                            </ul>
